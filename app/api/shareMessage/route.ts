...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (type === 'send') {
      payload = {
        photo_url: 'https://prodev2024.vercel.app/share/send212.png', // 发送完整的图片
        thumb_url: 'https://prodev2024.vercel.app/share/send212.png', // 预览缩略图
    ...
    if (type === 'raffle') {
      payload = {
        photo_url: 'https://prodev2024.vercel.app/share/raffle212.png', // 发送完整的图片
        thumb_url: 'https://prodev2024.vercel.app/share/raffle212.png', // 预览缩略图
