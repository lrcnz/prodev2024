      ...
      <div className="bg-white flex flex-col h-full">
        ...
        <div className='flex-1 flex items-center justify-center mb-32'>
          <svg width="128" height="128" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M115.893 30.2941L46.5599 104.961C45.5547 106.045 44.1448 106.663 42.6666 106.667C41.249 106.676 39.8864 106.119 38.8799 105.121L12.2133 78.4541C10.1219 76.3628 10.1219 72.9721 12.2133 70.8808C14.3046 68.7895 17.6953 68.7895 19.7866 70.8808L42.6666 93.6541L108.107 23.0408C109.362 21.4929 111.375 20.7739 113.327 21.1766C115.279 21.5793 116.843 23.0366 117.383 24.9549C117.923 26.8732 117.348 28.9325 115.893 30.2941Z" fill="#007AFF" />
          </svg>
        </div>
        <Footer active="send" />
      </div>
