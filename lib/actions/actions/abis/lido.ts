export const LIDO = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'preRebaseTokenAmount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'postRebaseTokenAmount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'sharesAmount', type: 'uint256' },
    ],
    name: 'SharesBurnt',
    type: 'event',
  },
